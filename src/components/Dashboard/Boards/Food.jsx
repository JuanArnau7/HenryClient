  ...
  const handleClickCreate = async (e) => {
	...
	return (
      ...
      <button onClick={(e) => handleClickCreate(e)}
									className="focus:outline-none text-white m-5 md:text-center bg-green-500 hover:bg-green-900 focus:ring-4 font-medium rounded-lg text-md px-5 py-2 dark:text-gray-900 dark:bg-gray-400 dark:hover:bg-gray-600">
									Create new food
								</button>
      </div>
					...
					<div className="relative w-full h-full max-w-md md:h-auto">
						<div className="relative bg-white rounded-lg shadow dark:bg-gray-700">
							...
							<div className="px-6 py-6 lg:px-8">
								<h3 className="mb-4 text-xl font-medium text-gray-900 dark:text-white">Update Food information</h3>
								<form onSubmit={handleSubmit} className="space-y-6">
									...
									<button type="submit" className="w-full text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Update info food</button>
								</form>
							</div>
						</div>
					</div>
