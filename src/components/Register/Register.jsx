								...
								<div className="bg-white px-4 py-5 sm:p-6">
									<div className="grid grid-cols-6 gap-6">
										<div className="col-span-6 sm:col-span-3">
											...
											<input onChange={handleChange} type="text" name="fullName" id="first-name" autoComplete="given-name" className=" h-7 mt-1 block w-full rounded-md border border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm" />
										...
										<div className="col-span-6 sm:col-span-4 ">
											...
											<input onChange={handleChange} type="text" name="email" id="email-address" autoComplete="email" className="h-7 mt-1 relative w-full rounded-md border border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm " />
