         ...
         <div className=" top-0 left-25 right-0">
            ...
            <div className={` ${open ? 'w-80' : 'w-0' } bg-green-700 dark:bg-green-900 min-h-screen w-80 fixed top-0 left-0 transition-all duration-300`}>
               <div className={` ${!open && 'hidden' } my-3`}>
                  ...
                  :
                  <>
                  <div className='text-center text-black text-xl hover:bg-gray-400 cursor-pointer py-3 mb-2'>
                     <button  className="text-black  text-xl bg-transparent   font-medium rounded-lg px-4 py-2.5 text-center inline-flex items-center dark:focus:ring-blue-800" type="button" onClick={()=>setFiltros(Filtros? false : true)}>Filters <svg className="ml-2 w-4 h-4" aria-hidden="true" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M19 9l-7 7-7-7"></path></svg></button>
                     {Filtros?
                     <FiltroCategoria/>
                     :
                     <></>
                  ...
                  <div className='text-center text-black text-xl hover:bg-gray-400 cursor-pointer py-3 mb-2'>
                     <button  className="text-black  text-xl bg-transparent   font-medium rounded-lg px-4 py-2.5 text-center inline-flex items-center dark:focus:ring-blue-800" type="button" onClick={()=>setSorts(Sorts? false : true)}>Sort <svg className="ml-2 w-4 h-4" aria-hidden="true" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M19 9l-7 7-7-7"></path></svg></button>
                     {Sorts?
                     <FiltroPrecios/>
                     :
                     <></>
