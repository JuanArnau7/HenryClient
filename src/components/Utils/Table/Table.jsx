      ...
      <table class="border-collapse bg-white text-left text-sm text-gray-500">
        <thead class="bg-gray-50">
          <tr>
            ...
            <th scope="col" class="px-6 py-4 font-medium text-right text-white"><button class="bg-gray-600 px-3 py-1 rounded-md shadow-md">Add</button></th>
          </tr>
        </thead>
          ...
          <tr class="hover:bg-gray-50">
            ...
            <td class="px-6 py-4">
              <div class="flex justify-end gap-4">
                ...
                <span x-data="{ tooltip: 'Edite' }" href="#">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    fill="none"
                    viewBox="0 0 24 24"
