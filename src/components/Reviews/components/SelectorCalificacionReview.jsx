...
const SelectorCalificacionReview = ({setCalificacion}) => {
  ...
  return (
    <>
    <label htmlFor="countries" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Qualification</label>
        ...
        <option value="INSUFICIENTE">Insufficient</option>
        </select>
    </>
  )
}
